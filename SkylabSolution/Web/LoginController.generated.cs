...
namespace Skylab.Web.Controllers
{
    public partial class LoginController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string LoginUser = "~/Views/Login/LoginUser.cshtml";
            public readonly string LogoutUser = "~/Views/Login/LogoutUser.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_LoginController : Skylab.Web.Controllers.LoginController
    {
        public T4MVC_LoginController() : base(Dummy.Instance) { }

        [NonAction]
        partial void LoginUserOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult LoginUser()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.LoginUser);
            LoginUserOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void LogoutUserOverride(T4MVC_System_Web_Mvc_ViewResult callInfo);
